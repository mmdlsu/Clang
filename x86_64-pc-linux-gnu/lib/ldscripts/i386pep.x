...
SEARCH_DIR("/root/tc-build/MrLiClang-11/x86_64-pep/lib"); SEARCH_DIR("/root/tc-build/MrLiClang-11/lib"); SEARCH_DIR("/usr/local/lib"); SEARCH_DIR("/lib"); SEARCH_DIR("/usr/lib");
SECTIONS
{
